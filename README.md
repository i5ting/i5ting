...
<img src='IMG_4553.png' width='300px' height='300px'>
...
- 自动化部署想法演进过程 1)最开始每台机器登录，拷贝，编写shell脚本，烦。 2)采用ssh和scp，去掉sshkey，以一主机为主，向其他机器scp安装文件，ssh远程执行命令完成启动安装，问题是去掉sshkey密码是一个苦力活，需要改进。 3)采用apache Ant，利用sshexec和scp这2个task，密码可以动态传入，也可以写到配置文件中，日志规范，部署简洁，问题是需要依赖java和ant。 4)最后用c封装了ssh2，实现配置化，不依赖java即可完成安装部署。
...
- 2013年加入新浪，负责新浪财经客户端
- 2014和2015年加入国信灵通（网秦子公司），技术总监，首席架构师，负责多个项目，主管架构与培训
- 2015年4月到2016年6月，空弦科技CTO，负责公司所有技术相关工作
